...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/oscar/.vscode/extensions/wallabyjs.console-ninja-1.0.376/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20ecf6f3b265c0e0da91d0UE1fAUgCWFQHVgFUVQIBBV1TAAIE', mode: 'build'}); } catch(cjsError) { try { import('file:///home/oscar/.vscode/extensions/wallabyjs.console-ninja-1.0.376/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20ecf6f3b265c0e0da91d0UE1fAUgCWFQHVgFUVQIBBV1TAAIE', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
